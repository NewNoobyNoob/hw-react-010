...
const UserForm = ({onFormSubmit, firstName, lastName}) => {
    ...
    return <form onSubmit={onSubmit}>
        <input type="text" placeholder="firstName" ref={firstNameRef} defaultValue={firstName} />
        <input type="text" placeholder="lastName" ref={lastNameRef} defaultValue={lastName} />
